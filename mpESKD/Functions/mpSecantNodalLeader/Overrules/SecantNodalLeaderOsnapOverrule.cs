namespace mpESKD.Functions.mpSecantNodalLeader.Overrules
{
    ...
    /// <inheritdoc />
    public class SecantNodalLeaderOsnapOverrule : OsnapOverrule
    {
        private static SecantNodalLeaderOsnapOverrule _instance;

        /// <summary>
        /// Singleton instance
        /// </summary>
        public static SecantNodalLeaderOsnapOverrule Instance()
        {
            if (_instance != null)
            {
                return _instance;
            ...
            _instance = new SecantNodalLeaderOsnapOverrule();
        ...
        {
            Debug.Print("SecantNodalLeaderOsnapOverrule");
