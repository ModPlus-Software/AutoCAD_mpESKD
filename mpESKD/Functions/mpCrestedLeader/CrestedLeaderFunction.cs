// todo Добавить ручки начал выносок кроме той, в начале которой точка вставки
// todo Временную графику при таскании выносок заменить на прорисовку или добавить временную графику полки
// todo Добавить ручки: 'Вставить выноску' 'Удалить выноску' 'Выбрать тип стрелки'
// todo Ввести ограничение когда тащится конец выноски к ее началу
