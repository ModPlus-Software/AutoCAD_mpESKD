namespace mpESKD.Functions.mpNodalLeader.Overrules
{
    ...
    /// <inheritdoc />
    public class NodalLeaderOsnapOverrule : OsnapOverrule
    {
        private static NodalLeaderOsnapOverrule _instance;

        /// <summary>
        /// Singleton instance
        /// </summary>
        public static NodalLeaderOsnapOverrule Instance()
        {
            if (_instance != null)
            {
                return _instance;
            ...
            _instance = new NodalLeaderOsnapOverrule();
        ...
        {
            Debug.Print("NodalLeaderOsnapOverrule");
